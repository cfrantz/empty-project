...
PYBIND11_MODULE(gui, gui)
{
    ...
    */
    ...
    , py::arg("p_open") = nullptr
    , py::return_value_policy::automatic_reference);
    gui.def("show_stack_tool_window", [](bool * p_open)
    {
    ...
    , py::return_value_policy::automatic_reference);
    gui.def("begin_child", py::overload_cast<const char *, const ImVec2 &, bool, ImGuiWindowFlags>(&ImGui::BeginChild)
    , py::arg("str_id")
    , py::arg("size") = ImVec2(0,0)
    , py::arg("border") = false
    , py::arg("flags") = 0
    , py::return_value_policy::automatic_reference);
    gui.def("begin_child", py::overload_cast<ImGuiID, const ImVec2 &, bool, ImGuiWindowFlags>(&ImGui::BeginChild)
    , py::arg("id")
    , py::arg("size") = ImVec2(0,0)
    , py::arg("border") = false
    , py::arg("flags") = 0
    ...
    */
    ...
    , py::arg("count") = 1
    , py::return_value_policy::automatic_reference);
    gui.def("push_allow_keyboard_focus", &ImGui::PushAllowKeyboardFocus
    , py::arg("allow_keyboard_focus")
    , py::return_value_policy::automatic_reference);
    gui.def("pop_allow_keyboard_focus", &ImGui::PopAllowKeyboardFocus
    , py::return_value_policy::automatic_reference);
    ...
    */
    ...
    , py::return_value_policy::automatic_reference);
    gui.def("set_item_allow_overlap", &ImGui::SetItemAllowOverlap
    , py::return_value_policy::automatic_reference);
    ...
    */
    ...
    , py::return_value_policy::automatic_reference);
    gui.def("begin_child_frame", &ImGui::BeginChildFrame
    , py::arg("id")
    , py::arg("size")
    , py::arg("flags") = 0
    , py::return_value_policy::automatic_reference);
    gui.def("end_child_frame", &ImGui::EndChildFrame
    , py::return_value_policy::automatic_reference);
    ...
    */
    ...
    , py::return_value_policy::automatic_reference);
    ListClipper.def("force_display_range_by_indices", &ImGuiListClipper::ForceDisplayRangeByIndices
    , py::arg("item_min")
    , py::arg("item_max")
    , py::return_value_policy::automatic_reference);
